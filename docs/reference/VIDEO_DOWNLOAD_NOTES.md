# Video Download Notes (Manual Only)

Video/MP4 downloads are no longer automated in the extractor. This document captures
what we learned from previous automation attempts so we can revisit later if needed.
